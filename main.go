...
import (
	...
	"github.com/julioguillermo/nqueens_opt/nqueens"
	"github.com/julioguillermo/nqueens_opt/simple"
)
...
func main() {
	...
	simpleRandAlg := flag.Bool("rsimple", false, "use Iterative Improvement Algorithm instead of GA with random selection")
	simpleHeurAlg := flag.Bool("hsimple", false, "use Iterative Improvement Algorithm instead of GA with heuristic selection")
	simpleFHeurAlg := flag.Bool("fhsimple", false, "use Iterative Improvement Algorithm instead of GA with a fast heuristic selection")
